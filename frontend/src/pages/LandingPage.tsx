    ...
    <div className="min-h-screen relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <Link 
            to="/journal"
            className="group bg-white rounded-2xl shadow-lg shadow-blue-500/40 p-8 transition-all duration-300 transform hover:scale-105 hover:-rotate-1 "
          >
            ...
            <h3 className="text-xl font-semibold text-black mb-3">My Journal</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-black mb-3">Mental Health Blogs</h3>
            <p className="text-black/70 leading-relaxed">
          ...
          <Link 
            to="/chat"
            className="group bg-white rounded-2xl shadow-lg shadow-blue-500/40 p-8 transition-all duration-300 transform hover:scale-105 hover:-rotate-1 md:col-span-2 lg:col-span-1"
          >
            <div className="w-16 h-16 bg-gradient-to-br from-blue-400 to-black rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 shadow-md shadow-blue-500/30">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 className="text-xl font-semibold text-black mb-3">Meet Eve</h3>
            <p className="text-black/70 leading-relaxed">
